...
#' @param g_chartcolour_palettes loaded palettes, using get_g_chartcolour_palettes
#' @export
#' plot_g_chartcolour_palettes()


plot_g_chartcolour_palettes <- function(g_chartcolour_palettes){

  ggplot2::ggplot(dplyr::bind_rows(g_chartcolour_palettes),
                  aes(factor(index),
             factor(palette),
    ...
    ggplot2::scale_fill_manual(values = g_chartcolour_palettes$hex_code)+
    ggplot2::theme(
